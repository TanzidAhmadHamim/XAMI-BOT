...
.then(response => {
    ...
    return api.sendMessage("চলে এসেছি আমি পিচ্চি xami তোমাদের মাঝে🤭!", event.threadID, () => api.sendMessage({ body: `Xami ʙᴏᴛ ɪꜱ ᴄᴏɴɴᴇᴄᴛᴇᴅ...\nᴛʜᴀɴᴋ ʏᴏu ꜰᴏʀ ᴀᴅᴅɪɴɢ ᴍᴇ \n ɴᴀᴍᴇ :${global.config.BOTNAME}\nᴘʀᴇꜰɪx :『  ${global.config.PREFIX} 』\nᴏᴡɴᴇʀ : \n sohel xami\n╰──────•◈•───────╯`, attachment: fs.createReadStream(gifPath)}, threadID));
})
.catch(error => {
    console.error(error);
});
    ...
    try {
      ...
      (typeof threadData.customJoin == "undefined") ? msg = `Dᴇᴀʀ, {name}\nᴡᴇʟᴄᴏᴍᴇ ᴛᴏ |ᴏᴜʀ ꜰᴀᴍɪʟʏ 🌸\n |ɢᴄ : {threadName}\nᴍᴇᴍʙᴇʀ ɴᴏ : [ {soThanhVien} ]\nᴊᴏɪɴ ᴛɪᴍᴇ: [ {time} - {thu} ]\nʙᴏᴛ ᴏᴡɴᴇʀ: SOHEL XAMI` : msg = threadData.customJoin;
